...
# Tex
We have the `tex` folder, which contains the final thesis in LaTeX format. 

# Prog
The `_prog` folder contains the programming parts of the thesis. The programs are written in `c#` `.NET8`.\
