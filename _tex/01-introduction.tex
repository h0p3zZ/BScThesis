...
\begin{figure}[!ht]
      ...
      \begin{tikzpicture}
            ...
            \node[draw, rectangle, minimum width=3cm, minimum height=1cm, below=2.5cm of ir] (solver) {Constraint Solver};
            \node[draw, rectangle, minimum width=3cm, minimum height=1cm, below=2.5cm of frontend] (schedule) {Generated Schedule};
