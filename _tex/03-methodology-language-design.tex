...
\subsection*{Horizon}
This \textit{horizon} field is solely to define the length of time the solver can define tasks to - the amount of time slots. Wihtout defining such a stopper, one would have to take infinite time into account which is not needed for a scheduling application.
