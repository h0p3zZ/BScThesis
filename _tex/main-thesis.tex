...
\title{Intermediate Representation for Modeling Soft and Hard Time Constraints}
...
\author{Daniel~Wimmer \matno{12205835}}

%% Command \supervisor[number,gender]{name}: sets the name of the supervisor (where number optionally
%%   defines the rank of the supervisor (1-3) and gender specifies if the supervisor is male or femalefinstit
%%   to adapt gener-specific terms in German)
\supervisor{\prefix{Dr.} Adrian~Rebola-Pardo}
...
\submissiondepartment{Institute of Symbolic~Artificial~Intelligence}
...
\import{./}{02-preliminaries-related-work}
\import{./}{03-methodology-language-design}
\import{./}{04-formal-framework}
% ...
